...
public class SignalGeneratorTest {
    ...
    public void generateSignalTest() {
        ...
        signalGenerator.getSma2().setRecentPrice(0, Double.valueOf(1));
        signalGenerator.getSma2().setRecentPrice(1, Double.valueOf(2));
        signalGenerator.generateSignal();
        assertEquals(signalGenerator.getCurrentPosition(), -1);
        signalGenerator.getSma1().setRecentPrice(0, Double.valueOf(2));
        signalGenerator.generateSignal();
        assertEquals(signalGenerator.getCurrentPosition(), 1);
    }
}
